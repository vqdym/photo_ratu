...
const dictionary = {
  uk: {
    code: "404",
    title: "Фотосесію не знайдено",
    desc: "Цю фотосесію не знайдено. Можливо, вона була видалена або ви ввели неправильну адресу.",
    btn: "Повернутися до портфоліо",
  },
  en: {
    code: "404",
    title: "Photosession not found",
    desc: "It looks like this page doesn't exist. It might have been removed or the URL is incorrect.",
    btn: "Return to portfolio",
  },
};
