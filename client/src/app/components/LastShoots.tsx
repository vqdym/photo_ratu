...
export default async function LastShoots({
  ...
  return (
    <div className="w-full drop-shadow-[0_10px_15px_rgba(0,0,0,0.35)] relative z-10 mt-[-6vw]">
      <section className="w-full bg-beige-200 pt-[calc(6vw+5rem)] pb-24 md:pb-[calc(6vw+5rem)] animate-fade-up [clip-path:polygon(0_6vw,100%_0,100%_calc(100%_-_6vw),0_100%)]">
